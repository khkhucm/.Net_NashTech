...
namespace Test.Data.Migrations
{
    ...
    [Migration("20221111022336_SeventhMigration_Test")]
    partial class SeventhMigration_Test
    {
            ...
            modelBuilder.Entity("Test.Data.Entities.BookRequest", b =>
                {
                    ...
                    b.Property<int?>("ApprovalModifiedByUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApprovalModifiedByUserId");
                    ...
                    b.HasData(
                        ...
                        {
                            RequestId = 1,
                            RequestedDate = new DateTime(2022, 11, 11, 9, 23, 35, 618, DateTimeKind.Local).AddTicks(7558),
                            Status = 0,
                            UserId = 1
                        },
                        new
                        {
                            RequestId = 2,
                            ApprovalById = 3,
                            RequestedDate = new DateTime(2022, 11, 11, 9, 23, 35, 618, DateTimeKind.Local).AddTicks(7572),
                            Status = 0,
                            UserId = 2
                        },
                        new
                        {
                            RequestId = 3,
                            ApprovalById = 4,
                            RequestedDate = new DateTime(2022, 11, 11, 9, 23, 35, 618, DateTimeKind.Local).AddTicks(7575),
                            Status = 1,
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("Test.Data.Entities.BookRequestDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            BookId = 4,
                            RequestId = 3,
                            ReturnDate = new DateTime(2022, 11, 11, 9, 23, 35, 618, DateTimeKind.Local).AddTicks(7807),
                            Status = 2
                        });
                });
            ...
            modelBuilder.Entity("Test.Data.Entities.BookRequest", b =>
                {
                    b.HasOne("Test.Data.Entities.User", "ApprovalModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovalModifiedByUserId");
